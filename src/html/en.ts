export const trad = {
    ...
    book_now_popup_text_3: `The Standard rooms are configured “Scandinavian style”, everyone has their own bed 🙂.`,
    ...
    book_now_popup_text_5: `The establishment is not suitable for welcoming babies and young children.`,
    book_now_popup_text_6: `The 2 Alpes resort is 12 minutes away (10 km). No public transport in Mizoën, you must have your car. The Chalet has free parking.`,
...
These comfortable rooms with Ecocert cotton bed sheets also offer you the opportunity to try the “Scandinavian style", each having their own bed.
