export const trad = {
    ...
    book_now_popup_text_1: `Doors are closed from noon to 4 p.m. and after 10 p.m.`,
    book_now_popup_text_2: `The 2 Alpes resort is 12 minutes away (10 km). No transports in Mizoën, you must be have a car.`,
    book_now_popup_text_3: `Please specify in comments if you would like 2 single beds, because by default the rooms are prepared with a double bed.`,
    book_now_popup_text_4: `Please specify in the comments your possible specific diet, because the restaurant offers a unique menu every evening.`,
    book_now_popup_text_5: `We cannot accept pets.`,
    book_now_popup_text_6: `The hotel is not adapted for babies and young children.`,
