export const trad = {
    ...
    book_now_popup_text_5: `L'établissement n'est pas adapté à l'accueil de bébés et jeunes enfants.`,
    book_now_popup_text_6: `La station des 2 Alpes est à 12 minutes (10 km). Pas de transport en commun à Mizoën, vous devez être véhiculé. Le Chalet dispose d'un parking gratuit.`,
