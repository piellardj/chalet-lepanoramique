export const trad = {
    ...
    book_now_popup_text_1: `L'établissement réouvre à 16h et ferme à 22h. Je vous invite à organiser votre arrivée dans ce créneau, avant 19h30 si vous souhaitez diner.`,
    book_now_popup_text_2: `Les chambres Panoramique sont configurées en lit double, merci de préciser en commentaire si vous souhaitez 2 lits simples.`,
    book_now_popup_text_3: `Les chambres Standard sont configurées « à la scandinave », chacun son lit 🙂.`,
    book_now_popup_text_4: `Je vous invite à mentionner également en commentaire votre régime spécifique, le restaurant proposant un menu unique.`,
    book_now_popup_text_5: `J'ai le regret de ne pouvoir accueillir vos animaux de compagnie.`,
    book_now_popup_text_6: `L'établissement n'est pas adapté à l'accueil de bébés et jeunes enfants.`,
    book_now_popup_text_7: `La station des 2 Alpes est à 12 minutes (10 km). Pas de transport en commun à Mizoën, vous devez être véhiculé. Le Chalet dispose d'un parking gratuit.`,
    book_now_popup_title: `Informations importantes avant de réserver`,
    nav_menu: `Menu`,
...
Ma seule volonté : rendre votre séjour dans mon chalet inoubliable, votre expérience unique !`,
    ...
    section_rooms_premium_body: `Laissez-moi tout d'abord vous présenter les chambres Premium Panoramique, et
...
Bien entendu vous trouverez également de la limonade, des jus de fruit, du cola et tant d'autres boissons artisanales.`,
    ...
    Vous pourrez vous exercer sur les routes empruntées par le Tour de France et participer à des courses telles que la prestigieuse course de la Marmotte.
    ...
    section_summer_rando_p1: `Un océan de verdure, calme et reposant, au cœur des reliefs escarpés de l'Oisans, vous réserve des escapades riches en émerveillement et émotions, que vous soyez à cheval ou à pied : le Plateau d'Emparis classé Natura 2000 et son lac Lérié et le lac Noir, la Croix de Cassini, le barrage du Chambon, le Lac des Quirlies, le Pic du Mas de la Grave...
Les GR50 et GR54 sont à proximité du chalet.`,
    section_summer_vtt_title: `VTT`,
    section_summer_vtt_p1: `Rejoignez une boucle de 36 km et découvrez le Plateau d'Emparis qui offre des paysages fabuleux, des prairies fleuries à perte de vue avec en toile de fond La Meije et ses glaciers, le tout à environ 2000 m d'altitude.
Par le Col de Sarenne grimpez à l'Alpe d'Huez et faites le tour de La Garde.
Mais aussi le chemin des Demoiselles des 2 Alpes ou sa spectaculaire descente de 2600 m de dénivelé vers Venosc, la descente du Pic Blanc de l'Alpe d'Huez, et tant d'autres.`,
    section_summer_ski_title: `Ski d'été`,
    section_summer_ski_p1: `Les skieurs ne seront pas en reste, puisque même en été, Les 2 Alpes vous accueille sur le Glacier du Dôme de la Lauze où même les débutants trouveront des pistes faciles.
...
Vous aurez tant à faire en Oisans, que ce soit juste éveiller votre curiosité pour le monde vertical ou tenter de vivre le rêve de tout alpiniste : se faire une place, le temps d'une course, dans ce milieu impressionnant, parfois inhospitalier mais si grandiose.`,
    ...
    section_summer_more_p1: `Amis bikers, sachez que le territoire est parfait pour vos balades, tel le Grand Marathon, 260 km des plus belles routes de l'Oisans.
...
Tout comme les activités culturelles, visites guidées ou ateliers artistiques.`,
    ...
    section_winter_ski_p2: `Avec une neige naturelle garantie grâce au glacier culminant à 3600 m d'altitude, vous avez l'assurance de skier en toute saison.
Ce domaine skiable est un véritable paradis de la glisse qui s'étend sur 410 hectares de pistes balisées.
C'est l'un des plus hauts sommets skiables des Alpes avec un dénivelé maximum de 2300 m négatif.
Sa verticalité permet d'enchaîner les virages sur une piste partant du glacier à 3600 m et allant jusqu'au village de Mont de Lans à 1300 m.
...
Vous préférez peut-être les espaces bien être et la remise en forme, les promenades en raquettes, la patin à glace, les descentes de luges... à vous de choisir !`,
    ...
    section_infos_breakfast: `Petit déjeuner`,
    section_infos_nosmoking: `Chambres non-fumeurs`,
    section_infos_nopets: `Animaux domestiques interdits`,
